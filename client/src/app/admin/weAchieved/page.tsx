...
const WeAchievedTable = dynamic(() => import('@/components/Tables/WeAchievedTable'), {
...
export default function Home() {
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/admin/weAchieved`, {
                method: 'POST',
                headers: {
                    Authorization: `Bearer ${storedUserInfo}`,
                },
                ...
                <div className="bg-gray-100 py-12">
                    <div className="max-w-3xl mx-auto bg-white border-2 border-[#F17B21] rounded-lg shadow-lg p-8">
                        <div className="text-center">
                            <h2 className="text-3xl font-bold text-black">We Achieved</h2>
                        </div>
