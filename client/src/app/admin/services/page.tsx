...
const ServicesTable = dynamic(() => import('@/components/Tables/ServicesTable'), {
...
export default function Home() {
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        try {
            ...
            if (formData.logo) form.append('logo', formData.logo);  // Corrected key for video file
                    ...
                    <div className="max-w-3xl mx-auto bg-white border-2 border-[#F17B21] rounded-lg shadow-lg p-8">
                        ...
                        <form onSubmit={handleSubmit} className="mt-10">
                            ...
                            <div className="flex gap-4 mb-6">
                                ...
                                <div className="w-1/2">
                                    <label htmlFor="Sub Title" className="block text-gray-900 font-semibold mb-2">
                                        Sub Title
                                    </label>
                                    <input
                                        id="subTitle"
                            ...
                            <div className="flex gap-4 mb-6">
                                ...
                                <div className="w-1/2">
                                    <label htmlFor="mainTitle" className="block text-gray-900 font-semibold mb-2">
                                        Main Title
                                    </label>
                                    <input
                                        id="mainTitle"
