...
export default function Home() {
    ...
    const [formData, setFormData] = useState({
        title: '',
        image: null,
        discription: '',  // Fixed the spelling: 'description' should be used
    });
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }) => {
        ...
        try {
            ...
            form.append('discription', formData.discription); // Ensure 'description' is spelled correctly
            ...
            if (!response.ok) {
                ...
                setFormData({
                    title: '',
                    image: null,
                    discription: '',  // Reset the description
                });
            }
        } catch (error) {
    ...
    const handleEditorChange = (newContent: string) => {
        // Handle the Jodit editor content change
        setFormData((prev) => ({
            ...prev,
            discription: newContent, // Update the description in formData
        }));
    };
