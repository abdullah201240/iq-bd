...
const BestProjectTable = () => {
    const router = useRouter();
    const [services, setServices] = useState<BestProject[]>([]);
        ...
        const checkSession = async () => {
            ...
            try {
                ...
                const teamResponse = await fetch(
                    `${process.env.NEXT_PUBLIC_API_URL}/admin/viewBestProject`,
                    {
                        method: 'GET',
                        headers: {
                            Authorization: `Bearer ${storedUserInfo}`,
    ...
    const handleDelete = async (id: number) => {
        ...
        try {
            const response = await fetch(
                `${process.env.NEXT_PUBLIC_API_URL}/admin/deleteBestProject/${id}`,
                {
                    method: 'DELETE',
                    headers: {
                        Authorization: `Bearer ${storedUserInfo}`,
...
export default BestProjectTable;
